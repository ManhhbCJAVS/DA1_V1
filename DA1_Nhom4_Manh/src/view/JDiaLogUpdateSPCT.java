...
//------------------------------------------------------------------------------    
    ...
    public IspctInsert getSPCTUpdate(int id_SPCT) {//Thực hiện update tất cả thông số theo ID_SPCT nhưng ko update tên.SP
        ...
        spctInsert.setId_thuongHieu(fa.getMaThuocTinhToName("danh sách thương hiệu", dcbThuongHieu.getSelectedItem().toString(), FthuongHieu.class));//        System.out.println("ID_Thương Hiệu " + spctInsert.getId_thuongHieu());

        spctInsert.setId_kichThuoc(fa.getMaThuocTinhToName("danh sách kích thước", dcbKichThuoc.getSelectedItem().toString(), AkichCo.class));//        System.out.println("ID_Kích Thước " + spctInsert.getId_kichThuoc());

        spctInsert.setId_mauSac(fa.getMaThuocTinhToName("danh sách màu sắc", dcbMauSac.getSelectedItem().toString(), DmauSac.class));//        System.out.println("ID_Màu_Sắc " + spctInsert.getId_mauSac());

        spctInsert.setId_chatLieu(fa.getMaThuocTinhToName("danh sách chất liệu", dcbChatLieu.getSelectedItem().toString(), BchatLieu.class));//        System.out.println("ID_Chất Liệu " + spctInsert.getId_chatLieu());
        ...
        spctInsert.setId_dayGiay(fa.getMaThuocTinhToName("danh sách dây giày", dcbDayGiay.getSelectedItem().toString(), EdayGiay.class));//        System.out.println("ID_Dây Giày " + spctInsert.getId_dayGiay());
...
//        System.out.println("moTaInput : " + moTaInput);System.out.println("MoTa.ĐS : " + String.valueOf(spctInstance.getMoTa()).trim());
    ...
    public boolean checkTonTaiAnhTrongThuMuc(String fileName) {
        File fileToCheck = new File("D:\\FPT_Semester_4_Block2\\DA1\\GiaoDienManh\\P4_HuongDanThietKeGiaoDienTrongJavaSwing\\src\\Product_images\\" + fileName);
    ...
    public static void save(File source_update_anh) { //Thực hiện lưu 1 ảnh = src.getName ( ra tên ảnh ) ( với đường dẫn tới ảnh đó = src vào thư mục lưu ảnh sản phẩm ( như ở dưới ) 
        ...
        File dst = new File("D:\\FPT_Semester_4_Block2\\DA1\\GiaoDienManh\\P4_HuongDanThietKeGiaoDienTrongJavaSwing\\src\\Product_images", source_update_anh.getName());
